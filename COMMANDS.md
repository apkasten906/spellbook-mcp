...
- `--scope` _(feature|service|repo)_ — optional, default: `feature`
...
- `/prompt list` → `prompt_list` (args: `base?: string`)
- `/prompt read` → `prompt_read` (args: `file: string`)
...
_Version:_ v0.3.0 · _Owner:_ Spellbook MCP · _Change policy:_ append new commands; don’t rename without alias.
